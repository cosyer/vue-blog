  ...
  >
    <div class="profile">
      <img
        ...
        alt=""
      >
      <div class="profile">cosyer</div>
    </div>
    <List style="padding-left:1.5rem;">
      <ListItem>
        <i class="iconfont icon-qq">: 535509852,</i>
        <i class="iconfont icon-weixin">: cy-535509852</i>
      </ListItem>
      <ListItem>
        <i
      ...
      <ListItem>
        <i
          ...
          class="iconfont icon-biaoti"
        > 云相册</i>
      </ListItem>
      <ListItem>
        <i
          @click="$router.push('/message')"
          class="iconfont icon-liuyan2"
        > 留言板</i>
      </ListItem>
      <ListItem>
        <i @click="Gogithub">
...
export default {
  ...
  methods: {
    ...
    Gogithub() {
      location.href = "https://github.com/cosyer";
    },
  },
};
</script>
